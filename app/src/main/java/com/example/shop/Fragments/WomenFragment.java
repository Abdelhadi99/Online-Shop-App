...
public class WomenFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        items.add(new Item(R.drawable.woman_items1));
        items.add(new Item(R.drawable.woman_items2));
        items.add(new Item(R.drawable.woman_items3));


        RecyclerView recyclerView = view.findViewById(R.id.recView_home_women_fragment);
...
// Set the layout manager to the RecyclerView
        ...
        // button see more
        LinearLayout btnSeeMore = view.findViewById(R.id.btnSeeMore_women_fragment);
